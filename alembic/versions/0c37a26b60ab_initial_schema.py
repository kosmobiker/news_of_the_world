...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_published_language", "articles", ["published_at", "language"], unique=False
    )
    ...
    op.create_index(
        "idx_daily_summaries_main_events",
        "daily_summaries",
        ["main_events"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        "idx_date_category_country", "daily_summaries", ["date", "category", "country"], unique=True
    )
    op.create_index(
        op.f("ix_daily_summaries_category"), "daily_summaries", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_daily_summaries_country"), "daily_summaries", ["country"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_daily_summaries_main_events", table_name="daily_summaries", postgresql_using="gin"
    )
    op.drop_index(
