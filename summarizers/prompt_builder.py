...
3) Length and style:
   ...
   - `top_articles`: Extract ALL articles with their exact links. Return up to 10 articles as an array of objects with EXACTLY these keys: "title" (from Title field), "source" (from Source field), "link" (from Link field). MUST preserve exact URLs as provided in input.
...
6. Extract the top 10 most relevant articles by relevance to main events and key themes. For EACH article, extract: title (from Title), source (from Source), and exact link (from Link field). Return as array of objects: [{{"title": "...", "source": "...", "link": "..."}}, ...]. DO NOT modify or shorten URLs.
