...
def _send_document(bot_token: str, chat_id: str, text: str):
    ...
    files = {
        'document': ('summary.txt', text.encode('utf-8'))
    }
    ...
    for idx, chunk in enumerate(chunks):
        ...
        while attempt < max_retries:
            ...
            try:
                ...
                logging.warning(f"Network error sending Telegram message (attempt {attempt+1}): {e}")
                attempt += 1
                continue
            ...
            try:
                ...
                last_resp = {'ok': False, 'error': 'invalid-json-response', 'status_code': resp.status_code}
